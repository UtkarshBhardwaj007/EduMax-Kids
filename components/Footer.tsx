...
const programs = [
  { name: 'Pre-Nursery', href: '/admissions' },
  { name: 'Nursery', href: '/admissions' },
  { name: 'Kindergarten (KG)', href: '/admissions' },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6">
              A premier primary school dedicated to nurturing young minds through quality education, creative learning, and holistic development.
            </p>
            {/* Social Links */}
            <div className="flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center bg-white/10 rounded-lg hover:bg-[#25D366] transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Programs */}
          <div>
            <h4 className="font-serif text-lg mb-6">Programs</h4>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-sm">
                ...
                <a href="tel:+919958864300" className="text-white/70 hover:text-secondary transition-colors">
                  +91 99588 64300
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm">
                ...
                <a href="mailto:edumaxkids2024@gmail.com" className="text-white/70 hover:text-secondary transition-colors">
      ...
      <div className="border-t border-white/10">
        <div className="container py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/50 text-sm">
            © {new Date().getFullYear()} EduMax Kids. All Rights Reserved.
          </p>
          <p className="text-white/50 text-sm">
